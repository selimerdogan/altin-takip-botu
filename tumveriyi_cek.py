...
# Gereksiz uyarıları gizle (Temiz ekran için)
...
# ==============================================================================
# 1. ABD BORSASI (S&P 500 - HATA VERENLER TEMİZLENDİ)
# ==============================================================================
# Çıkarılanlar: DFS, CPE, LPI, SWN, MRO, ESTE, PDCE, CHK, OAS, HES, WLL
LISTE_ABD = [
...
# ==============================================================================
# 4. BIST (TAM LİSTE - TEMİZLENDİ)
# ==============================================================================
# Çıkarılanlar: QNBFB, QNBFL, ISKUR, ITTFH, ALMAD, DAGHL, PEGYO, IDEAS, PLAT vb.
LISTE_BIST = [
    ...
    "DARDL.IS", "DENGE.IS", "DERHL.IS", "DERIM.IS", "DESA.IS", "DESPC.IS", "DEVA.IS", "DGATE.IS", "DGGYO.IS", "DGNMO.IS", "DIRIT.IS", "DITAS.IS", "DMSAS.IS", "DNISI.IS", "DOAS.IS", "DOBUR.IS", "DOCO.IS", "DOGUB.IS", "DOHOL.IS", "DOKTA.IS", "DURDO.IS", "DYOBY.IS", "DZGYO.IS", 
    ...
    "GARAN.IS", "GARFA.IS", "GEDIK.IS", "GEDZA.IS", "GENIL.IS", "GENTS.IS", "GEREL.IS", "GESAN.IS", "GIPTA.IS", "GLBMD.IS", "GLRYH.IS", "GLYHO.IS", "GMTAS.IS", "GOKNR.IS", "GOLTS.IS", "GOODY.IS", "GOZDE.IS", "GRNYO.IS", "GRSEL.IS", "GUBRF.IS", "GWIND.IS", "GZNMI.IS", 
...
try:
    print("--- MEGA FİNANS BOTU (PIRIL PIRIL MOD) ---")
    ...
    if any(final_paket.values()):
        ...
        print(f"🎉 BAŞARILI: [{bugun_tarih} - {su_an_saat_dakika}] Veriler Kaydedildi (Sıfır Hata).")
    else:
        print("❌ HATA: Veri yok!")
        sys.exit(1)
